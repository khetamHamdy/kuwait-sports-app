    ...
    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
        ...
        <div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
            <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                ...
                <!--end::Info-->
                <form method="post" action="{{ route('admin.poster.update' , $poster) }}"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9 col-xl-9">
                                    <input
                                        ...
                                        value="{{ $poster->image }}"/>
                                    <img src="{{asset('uploads/image/'.$poster->image)}}" height="200px" width="200px">
                                </div>
                            </div>
                            <!--end::Group-->
...
@section('script')
    <script>
        ...
        $(document).ready(function () {
            ...
            $(document).on('click', '.deletePosterImageBtn', function () {
                var Poster_image_id = $(this).val();
                var this_click = $(this);
                $.ajax({
                    type: "GET",
                    url: "/admin/" + "Poster-image/" + Poster_image_id + "/delete",
