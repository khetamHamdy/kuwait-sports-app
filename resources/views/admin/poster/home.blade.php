        ...
        <div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
            <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                ...
                <div>
                    ...
                    <a href="{{ route('admin.poster.create') }}" class="btn btn-secondary  mr-2 btn-success"
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover tableWithSearch" id="tableWithSearch">
                                ...
                                <tr>
                                    ...
                                    <th class="wd-5p"> {{ucwords(__('link'))}}</th>
                                ...
                                @foreach($poster as $one)
                                    <tr class="odd gradeX" id="tr-{{$one->id}}">
                                        ...
                                        <td class="v-align-middle wd-5p"><img
                                                src="{{ asset('uploads/image/'.$one->image) }}"
                                                width="90px"
                                                height="90px"></td>
                                        ...
                                        <td class="v-align-middle wd-25p">{{$one->link }}</td>
                                        ...
                                        <td>
                                            <div class="btn-group btn-action">
                                                <a href="{{ route('admin.poster.edit' , $one) }}"
                            ...
                            {{$poster->appends($_GET)->links("pagination::bootstrap-4") }}
                        </div>
                    </div>
                </div>
                <!--end::Card-->
