        ...
        <div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
            <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                ...
                <div>
                    ...
                    <a href="{{ route('admin.slider.create') }}" class="btn btn-secondary  mr-2 btn-success"
                ...
                <div class="gutter-b example example-compact">
                    ...
                    <div class="contentTabel">
                        ...
                        <div class="container box-filter-collapse">
                            <div class="card">
                                <form class="form-horizontal" method="get" action="{{route('admin.slider.filter')}}">
                                    <div class="row">
                                        <div class="col-md-4">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <a href="{{route('admin.slider.index')}}" type="submit"
                                    ...
                                    <tr class="odd gradeX" id="tr-{{$one->id}}">
                                        ...
                                        <td>
                                            <div class="btn-group btn-action">
                                                <a href="{{ route('admin.slider.edit' , $one) }}"
