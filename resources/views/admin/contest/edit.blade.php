    ...
    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
        ...
        <div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
            <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                ...
                <!--end::Info-->
                <form method="post" action="{{ route('admin.usercontest.update' , $usercontest) }}"
                      enctype="multipart/form-data" class="form-horizontal" role="form" id="form">
                    @csrf
                    @method('put')
                    <!--begin::Toolbar-->
                    <div class="d-flex align-items-center">
                        <a href="{{ route('admin.usercontest.index') }}"
                    ...
                    <div class="row col-sm-12">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                <label
                                    class="col-xl-3 col-lg-3 col-form-label">{{__('Description')}} </label>
                                <div class="col-lg-9 col-xl-9">
                                    <input
                                        class="form-control form-control-solid form-control-lg"
                                        name="description" value="{{$usercontest->description}}"
                                    />
                                </div>
                            </div>
                            <!--end::Group-->
                                ...
                                <div class="col-lg-9 col-xl-9">
                                    <select
                                        ...
                                        @foreach($status as $one => $key)
                                            <option value="{{$one}}"
                                                    @if($usercontest->status == $one) selected @endif>{{$key}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                                ...
                                <div class="col-lg-9 col-xl-9">
                                    <div class="fileinputForm">
                                        ...
                                        <div class="fileinput-new thumbnail"
                                            ...
                                            <img src="{{asset($usercontest->image)}}" id="editImage3">
                                        </div>
