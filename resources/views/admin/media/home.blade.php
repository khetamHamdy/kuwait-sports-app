        ...
        <div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
            <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                ...
                <div>
                    ...
                    <a href="{{ route('admin.media.create') }}" class="btn btn-secondary  mr-2 btn-success"
                ...
                <div class="gutter-b example example-compact">
                    ...
                    <div class="contentTabel">
                                ...
                                <form class="form-horizontal" method="get" action="">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <a href="{{route('admin.media.index')}}" type="submit"
                        ...
                        <div class="table-responsive">
                                    ...
                                    <tr class="odd gradeX" id="tr-{{$one->id}}">
                                        ...
                                        <td>
                                            <div class="btn-group btn-action">
                                                <a href="{{ route('admin.media.edit' , $one) }}"
                                            ...
                                            <div class="btn-group btn-action">
                                                <a href="{{route('admin.media.show' , $one)}}"
                            ...
                            {{$datamedia->appends($_GET)->links("pagination::bootstrap-4") }}
                        </div>
                    </div>
                </div>
                <!--end::Card-->
