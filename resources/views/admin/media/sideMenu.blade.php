        ...
        <div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
            <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                ...
                <div class="d-flex align-items-center">
                    <a href="{{ route('admin.media.index') }}" class="btn btn-success ">{{__('Cancel')}}</a>
                </div>
                <!--end::Toolbar-->
            </div>
        </div>
                        ...
                        <div class="card-body pt-4">
                            ...
                            <div class="d-flex align-items-center">
                                <div
                                    ...
                                    <div class="symbol-label"
                                         style="background-image:url('{{asset($medium->image)}}')">
                                    @if($medium->status=='active')
                                        <i class="symbol-badge bg-success"></i>
                                    @endif
                                        @if($medium->status=='not_active')
                            ...
                            <div class="py-9">
                                ...
                                <div class="d-flex align-items-center justify-content-between mb-2">
                                    ...
                                    <h6 class="text-muted">{{__($medium->status) ?? ''}}</h6>
                                </div>

                                <div class="d-flex align-items-center justify-content-between mb-2">
                                    <span class="font-weight-bold mr-3">{{__('Created')}}:</span>
                                    <h6 class="text-muted">{{$medium->created_at->diffForHumans()}}</h6>
                                </div>
