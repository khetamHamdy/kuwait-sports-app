    ...
    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
        ...
        <div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
            <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                ...
                <!--end::Info-->
                <form method="post" action="{{ route('admin.contest.update' , $contest) }}"
                ...
                <div class="card card-custom gutter-b example example-compact">
                    ...
                    <div class="row col-sm-12">
                        ...
                        <div class="card-body">
                                ...
                                <div class="col-lg-9 col-xl-9">
                                    <select
                                        ...
                                        @foreach($status as $one => $key)
                                            <option value="{{$one}}"
                                                    @if($contest->status == $one) selected @endif>{{$key}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                <label
                                    class="col-xl-3 col-lg-3 col-form-label">{{__('Closed Contest ?')}} </label>
                                <div class="col-lg-9 col-xl-9">
                                    <select
                                        class="form-control form-control-solid form-control-lg"
                                        name="closed_contest">
                                        @foreach($close as $one => $key)
                                            <option value="{{$one}}"
                                                    @if($contest->closed_contest == $one) selected @endif>{{$key}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9 col-xl-9">
                                    <input type="file" class="form-control form-control-solid form-control-lg"
                                           name="video" value="{{$contest->video}}">

                                    @if($contest->video)
                                        <video width="320" height="240" autoplay>
                                            <source src="{{asset($contest->video)}}" type="video/mp4">
                            ...
                            <div class="form-group row">
                                <label
                                    class="col-xl-3 col-lg-3 col-form-label">{{__('Open Contest')}} </label>
                                <div class="col-lg-9 col-xl-9">
                                    <input type="date" class="form-control form-control-solid form-control-lg"
                                           name="open_contest" value="{{$contest->open_contest}}">
                                </div>
                            </div>
                            <!--end::Group-->
                            ...
                            <div class="form-group row">
                                <label
                                    class="col-xl-3 col-lg-3 col-form-label">{{__('Close Contest')}} </label>
                                <div class="col-lg-9 col-xl-9">
                                    <input type="date" class="form-control form-control-solid form-control-lg"
                                           name="close_contest" value="{{$contest->close_contest}}">
                                </div>
                            </div>
                            <!--end::Group-->
                            <!--begin::Group-->
                                ...
                                <div class="col-lg-9 col-xl-9">
                                    <div class="fileinputForm">
                                        ...
                                        <div class="fileinput-new thumbnail"
                                            ...
                                            <img src="{{asset($contest->image)}}" id="editImage3">
                                        </div>
                                        <div class="btn btn-change-img red"
                                             onclick="document.getElementById('edit_image3').click()">
                                            <i class="fas fa-pencil-alt"></i>
                                        </div>
                                        <input type="file" class="form-control" name="image" value="{{$contest->image}}"
                                               id="edit_image3"
                                               style="display:none">
                                    </div>
                                </div>
                                    ...
                                    <div
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-9 col-xl-9">
                                                <input
                                                    ...
                                                    value="{{$contest->translate($key)->title}}"/>
                                            </div>
                                        </div>
                                        <!--end::Group-->
                                        <!--begin::Group-->
                                        <div class="form-group row">
                                         ...
                                         <textarea name="{{$key}}[description]"
                                                   ...
                                                   id="kt_summernote_1">{{$contest->translate($key)->description ?? ''}}</textarea>
                                            </div>
                                        </div>
                                        <!--end::Group-->
                                    </div>
