                    ...
                    <div class="row col-sm-12">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9 col-xl-9">
                                    <input type="date" class="form-control form-control-solid form-control-lg"
                                           name="open_contest" value="{{old('open_contest')}}">
                                </div>
                            </div>
                            <!--end::Group-->
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9 col-xl-9">
                                    <input type="date" class="form-control form-control-solid form-control-lg"
                                           name="close_contest" value="{{old('close_contest')}}">
                                </div>
                            </div>
                            <!--end::Group-->
                            ...
                            <div class="tab-content" id="myTabContent">
                                @foreach (config('app.languages') as $key => $lang)
                                    <div
                                        ...
                                        <div class="form-group row">
                                            <label
                                                class="col-xl-3 col-lg-3 col-form-label">{{__('Title')}} ( {{$lang}}
                                                )</label>
                                            <div class="col-lg-9 col-xl-9">
                                                <input
                                                    class="form-control form-control-solid form-control-lg"
                                                    name="{{$key}}[title]" type="text" value="{{ old("$key.title") }}"/>
                                            </div>
                                        </div>
                                        <!--end::Group-->
                                        <!--begin::Group-->
                                        <div class="form-group row">
                                            <label
                                                class="col-xl-3 col-lg-3 col-form-label">{{__('Description')}}
                                                ( {{$lang}} )
                                            </label>
                                            <div class="col-lg-9 col-xl-9">
