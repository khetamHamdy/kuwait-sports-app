            ...
            <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                ...
                <div>
                    <div class="btn-group mb-2 m-md-3 mt-md-0 ml-2 ">
                        ...
                        <a href="{{ route('admin.product.create') }}" class="btn btn-secondary  mr-2 btn-success" style="background: #fe4400 ;border: 0">
                ...
                <div class="gutter-b example example-compact">
                    ...
                    <div class="contentTabel">
                        ...
                        <div class="container box-filter-collapse">
                            <div class="card">
                                <form class="form-horizontal" method="get" action="{{route('admin.product.filter')}}">
                                    <div class="row">
                                        <div class="col-md-4">
                        ...
                        <div class="table-responsive">
                                        ...
                                        <tr class="odd gradeX" id="tr-{{$one->id}}">
                                            ...
                                            <td>
                                                <div class="btn-group btn-action">
                                                    <a href="{{ route('admin.product.edit' , $one) }}"
                                                ...
                                                <div class="btn-group btn-action">
                                                    <a href="{{route('admin.product.show' , $one)}}"
                            ...
                            {{$dataProduct->appends($_GET)->links("pagination::bootstrap-4") }}
                        </div>
                    </div>
                </div>
                <!--end::Card-->
